...
/* ONE SHOT · first-load runtime recovery.
   ...
   En la primera visita, antes de existir controlador, este cargador lee solamente DYNAMIC
   y deja los sprites pesados LAZY para el momento en que el usuario abre Editar con Fer. */
(()=>{
'use strict';
const CURRENT_SENTINEL=()=>!!(window.ONE_V6418_EDIT_CORE&&window.ONE_V6415_TERRITORY_OPS&&window.ONE_V6411_MUNICIPAL);
