/* ONE SHOT · COMPATIBILITY BOOTSTRAP · FIELD FLOW v6.6.18 */
(()=>{
'use strict';
const LEGACY_BUILD='oneshot-v6.4.3-data-edit-flow-fix-01';
const CURRENT_BUILD='oneshot-v6.6.18-field-flow-01';
...
function patchUpdater(){
  ...
  const timer=setInterval(()=>{
    ...
    try{
      ...
      clearInterval(timer);AppUpdater.__updateLoopHotfix='v6.6.18';
