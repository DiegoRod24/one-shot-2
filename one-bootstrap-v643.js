/* ONE SHOT · COMPATIBILITY BOOTSTRAP · UPDATER SAFE REFRESH v6.6.6 */
(()=>{
'use strict';
const LEGACY_BUILD='oneshot-v6.4.3-data-edit-flow-fix-01';
const CURRENT_BUILD='oneshot-v6.6.6-updater-safe-refresh-01';
...
function patchManualUpdateButton(){
  ...
  if(!btn||btn.dataset.oneUpdaterV666==='1')return;
  btn.dataset.oneUpdaterV666='1';
...
function patchUpdater(){
  ...
  const timer=setInterval(()=>{
    ...
    try{
      ...
      clearInterval(timer);
      AppUpdater.__updateLoopHotfix='v6.6.6';
