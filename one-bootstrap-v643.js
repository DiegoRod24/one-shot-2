/* ONE SHOT · COMPATIBILITY BOOTSTRAP · SYNC SIMPLE v6.6.16 */
(()=>{
'use strict';
const LEGACY_BUILD='oneshot-v6.4.3-data-edit-flow-fix-01';
const CURRENT_BUILD='oneshot-v6.6.16-sync-identity-01';
...
function patchUpdater(){
  ...
  const timer=setInterval(()=>{
    ...
    try{
      ...
      clearInterval(timer);AppUpdater.__updateLoopHotfix='v6.6.16';
