/* ONE SHOT · COMPATIBILITY BOOTSTRAP · TRAMO POSTES v6.6.17 */
(()=>{
'use strict';
const LEGACY_BUILD='oneshot-v6.4.3-data-edit-flow-fix-01';
const CURRENT_BUILD='oneshot-v6.6.17-tramo-postes-01';
...
function patchUpdater(){
  ...
  const timer=setInterval(()=>{
    ...
    try{
      ...
      clearInterval(timer);AppUpdater.__updateLoopHotfix='v6.6.17';
