/* ONE SHOT v6.6.7 · PERFORMANCE · IDLE FEATURE LOADER */
(()=>{
'use strict';
if(window.ONE_V661_IDLE_LOADER)return;
const BUILD='oneshot-v6.6.7-mobile-batch-classifier-01';
const FEATURES={
  mobile:['one-v667-mobile-batch.js'],
...
function warmByIntent(e){
  ...
  if(/seleccion|evidencia|clasificar|lote/.test(text))ensure('mobile').catch(()=>{});
