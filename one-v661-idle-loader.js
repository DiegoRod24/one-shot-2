/* ONE SHOT v6.6.23 · CAMERA-FIRST IDLE LOADER */
(()=>{
'use strict';
if(window.ONE_V661_IDLE_LOADER)return;
const BUILD='oneshot-v6.6.23-camera-first-idle-loader-01';
const FEATURES={
